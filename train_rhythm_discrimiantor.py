"""Rhythm Transformer Training Code
...
from discriminator import TransformerDiscriminator, Pitch_Discriminator, Rhythm_Discriminator, FocalLoss, Rhythm_Discriminator_with_rpe, Rhythm_Discriminator_with_rpe_val
...
# define model
# model = Rhythm_Discriminator(myvocab)
model = Rhythm_Discriminator_with_rpe(myvocab)
# model = Rhythm_Discriminator_with_rpe_val(myvocab)
model.cuda()
